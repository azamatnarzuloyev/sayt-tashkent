...
const service = services.find(s => s.slug === 'tehpodderzhka-saytov')!
...
export default function TehpodderzhkaSaytovPage() {
    ...
    <>
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Надежная поддержка вашего веб-сайта на всех этапах
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Системный подход к обслуживанию вашего веб-сайта
          </p>
