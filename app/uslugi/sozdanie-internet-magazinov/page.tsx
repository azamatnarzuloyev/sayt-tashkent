...
const service = services.find(s => s.slug === 'sozdanie-internet-magazinov')!
...
export default function SozdanieInternetMagazinovPage() {
    ...
    <>
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Наша команда создает интернет-магазины, которые реально продают
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Прозрачный процесс с контролем на каждом этапе
          </p>
