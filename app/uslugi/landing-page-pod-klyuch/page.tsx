...
const service = services.find(s => s.slug === 'landing-page-pod-klyuch')!
...
export default function LandingPagePodKlyuchPage() {
    ...
    <>
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Каждый элемент лендинга работает на конверсию
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            От идеи до запуска продающего лендинга за 7 дней
          </p>
