...
const service = services.find(s => s.slug === 'seo-prodvizhenie-saytov')!
...
export default function SeoProdvizhenieePage() {
    ...
    <>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Системный подход к SEO: от аудита до стабильного роста
          </p>
