  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-br from-primary to-accent rounded-full blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-br from-secondary to-primary rounded-full blur-3xl opacity-15 animate-pulse delay-1000"></div>
        ...
        <nav className="absolute top-0 left-0 right-0 z-20 p-6">
          <div className="container mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 text-sm">
              ...
              <span className="text-muted-foreground">info@sayt-tashkent.uz</span>
            </div>
          </div>
        </nav>
        ...
        <header className="relative z-10 container mx-auto px-4 text-left max-w-4xl">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-semibold text-accent">ВЕБ-СТУДИЯ SAYT-TASHKENT</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                variant="outline"
                size="lg"
                className="px-8 py-6 text-lg border-2 border-accent text-accent hover:bg-accent/10 bg-transparent"
              >
